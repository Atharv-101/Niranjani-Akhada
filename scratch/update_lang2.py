...
en_match_str = '"auto_key_262": "glorious tradition"'
new_en_match_str = '"auto_key_262": "glorious tradition",\n' + en_block

hi_match_str = '"auto_key_262": "गौरवशाली परंपरा"'
new_hi_match_str = '"auto_key_262": "गौरवशाली परंपरा",\n' + hi_block

content = content.replace(en_match_str, new_en_match_str)
content = content.replace(hi_match_str, new_hi_match_str)
